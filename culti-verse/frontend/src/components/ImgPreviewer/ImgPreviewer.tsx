...
const FullScreenIcon = (props: React.HTMLAttributes<unknown>) => {
...
export default function ImgPreviewer(props: {
  imgSrc: string;
  trigger: JSX.Element;
}) {
  function toggleFullScreen() {
    if (document.fullscreenElement) {
      ...
      const element = document.getElementsByClassName("PhotoView-Portal")[0];
      if (element) {
  ...
  return (
    ...
    >
      <PhotoView src={props.imgSrc}>{props.trigger}</PhotoView>
    </PhotoProvider>
  );
}
